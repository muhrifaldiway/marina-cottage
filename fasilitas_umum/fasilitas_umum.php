...
$fasilitas = query("SELECT * FROM fasilitas_umum");
...
<body>
  ...
  <header class="jumbotron jumbotron-fluid bg-primary text-white">
    <div class="container">
      <h1 class="display-4">Halaman Admin Fasilitas Umum Hotel</h1>
  ...
  <main class="container mt-5">
   ...
   <!-- Form Tambah Pemesanan -->
    <h2 class="mb-3 mt-5">Tambah Data Fasilitas Umum</h2>
...
<form action="" method="POST">
  ...
  <button type="submit" name="cari" class="btn btn-primary">Cari!</button>
     ...
     <!-- Tab Pemesanan -->
    <h2 class="mb-3">Data Fasilitas Umum</h2>
    <table class="table table-striped">
      <thead>
        ...
        <?php if(empty($fasilitas)): ?>
          <tr>
            <td colspan="4"><p style="color:red; font-style: italic;">data fasilitas umum tidak ditemukan!</p></td>
          </tr>
        <?php endif;?>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?= $f['keterangan'];?></td>
          <td>
            <a href="ubah.php?id_fumum=<?=$f['id_fumum'];?>" class="btn btn-success btn-sm" name="ubah">Ubah</a>
            <a href="hapus.php?id_fumum=<?=$f['id_fumum'];?>" onclick="return confirm
