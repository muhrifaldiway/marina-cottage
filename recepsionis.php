...
<head>
  ...
  <title>Halaman Recepsionis Hotel</title>
</head>
<body>
  <!-- Navigasi -->
  ...
  <header class="jumbotron jumbotron-fluid bg-primary text-white">
    <div class="container">
      <h1 class="display-4">Halaman Recepsionis Hotel</h1>
      <p class="lead">Selamat datang di halaman recepsionis Hotel XYZ. Disini Anda dapat mengelola pemesanan kamar dan mengatur kamar hotel.</p>
    </div>
  </header>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="recepsionis/ubah.php?id_pemesanan=<?=$p['id_pemesanan'];?>" type="button" class="badge badge-pill badge-success text-white" 
            >Ubah</a> 
            <hr>
